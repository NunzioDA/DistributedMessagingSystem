...
# pubbliche e private, decriptaggio delle chiavi e criptaggio e decriptaggio dei messaggi.
...
def decript_message(encrypted_message, password, encrypted_private_key, salt):
